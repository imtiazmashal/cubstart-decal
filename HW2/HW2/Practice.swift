...
var meta = "This is a project made by Mashal Imtiaz" //1. TODO: change this!
...
// notice: parameters have to be in the same order as they are in the struct
    let kitty = Animal(id: UUID(), name: "kitty", color: "gray", geography: "Saudi Arabia", domesticated: true, favFood: "tuna", lifespan: 9)
    let giraffe = Animal(id: UUID(), name: "giraffe", color: "yellow", geography: "Africa", domesticated: false, favFood: "greens", lifespan: 25)
    ...
    var body: some View {
        ScrollView{
            ...
            VStack{
                ...
                Group {
                  Text("this animal is usually GREY").foregroundColor(.gray)
                    //fix the second string to be the correct color
                }
            }
            ...
            VStack{
                // fill in here
                Text("I am a giraffe!").foregroundColor(.yellow)
                Text("I am usually the color yellow!").foregroundColor(.yellow)
            }
    }
